...
class FusionSolar:
    ...
    async def authenticate(self, username: str, password: str, subdomain: str) -> bool:
        ...
        try:
            ...
            self.client = FusionSolarClient(username, password, huawei_subdomain=subdomain)
